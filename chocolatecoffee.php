...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Chocolate Coffee Cafe' Amor</title>
   ...
   <body class="main-layout inner_page">
      ...
      <?php
      $xml = simplexml_load_file('Noche_IT2C_CafeAmor/chocolatecoffee.xml');
      ?>
      <!-- end loader -->
      <!-- header -->
      <div class="header">
               ...
               <div class="col-xl-1 col-lg-3 col-sm-2 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo">
                           <a href="home.php"><?php echo $xml->content->title; ?></a>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <nav class="navigation navbar navbar-expand-md navbar-dark ">
                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04">
                        <ul class="navbar-nav mr-auto">
                           <li class="nav-item ">
                              <a class="nav-link" href="home.php"><?php echo $xml->content->home; ?></a>
                           </li>
            ...
            <div class="row d_flex grid">
               <div class="col-md-6">
                  <div class="about_img text_align_center">
                     <figure><?php echo '<img src="images/chocolatecoffee.jpeg" alt="#"/>' ?></figure>
                  </div>
               </div>
               <div class="col-md-6 order1">
                  <div class="titlepage text_align_left">
                     <h2><?php echo $xml->content->product2; ?></h2>
                     <p><?php echo $xml->content->content1; ?>
                     </p>
      ...
      <footer>
         <div class="footer">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <a class="logo_bottom" href="home.php"><?php echo $xml->content->title; ?></a>
                  </div>
                  <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                           <div class="infoma text_align_left">
                              ...
                              <ul class="menu_bottom">
                                 <li><a href="home.php"><?php echo $xml->content->home; ?></a></li>
