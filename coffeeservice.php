...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Cafe' Amor Coffee Services</title>
   ...
   <body class="main-layout inner_page">
      ...
      <?php
      $xml = simplexml_load_file('Noche_IT2C_CafeAmor/coffeeservice.xml');
      ?>
      <!-- end loader -->
      <!-- header -->
      <div class="header">
            ...
            <div class="row d_flex grid">
               <div class="col-md-6">
                  <div class="about_img text_align_center">
                     <figure><?php echo '<img src="images/about.png" alt="#"/>' ?></figure>
                  </div>
               </div>
               <div class="col-md-6 order1">
                  <div class="titlepage text_align_left">
                     <h2><?php echo $xml->content->service1; ?></h2>
