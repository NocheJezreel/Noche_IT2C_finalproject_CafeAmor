...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Green Tea Cafe' Amor</title>
   ...
   <body class="main-layout inner_page">
      ...
      <?php
      $xml = simplexml_load_file('Noche_IT2C_CafeAmor/greentea.xml');
      ?>
      <!-- end loader -->
      <!-- header -->
      <div class="header">
            ...
            <div class="row d_flex grid">
               <div class="col-md-6">
                  <div class="about_img text_align_center">
                     <figure><?php echo '<img src="images/greentea.jpeg" alt="#"/>' ?></figure>
                  </div>
               </div>
               <div class="col-md-6 order1">
                  <div class="titlepage text_align_left">
                     <h2><?php echo $xml->content->product3; ?></h2>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="infoma text_align_left">
                              <h3><?php echo $xml->content->menu1; ?></h3>
