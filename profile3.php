...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Gilbert Ricamara's Profile</title>
   ...
   <body class="main-layout inner_page">
      ...
      <?php
      $xml = simplexml_load_file('Noche_IT2C_CafeAmor/profile3.xml');
      ?>
      <!-- end loader -->
      <!-- header -->
      <div class="header">
            ...
            <div class="row d_flex grid">
               <div class="col-md-6">
                  <div class="about_img text_align_center">
                     <figure><?php echo '<img src="images/bert.jpg" alt="#"/>' ?></figure>
                  </div>
               </div>
               <div class="col-md-6 order1">
                  <div class="titlepage text_align_left">
                     ...
                     <a class="read_more" href="https://web.facebook.com/gilberttetsuya.ordillano"><?php echo $xml->content->button; ?></a>
                  </div>
               </div>
            </div>
         </div>
